...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars",
                     "/D:/data-engineering/realtime_voting_system/postgresql-42.7.1.jar")  # PostgreSQL driver
             .config("spark.sql.adaptive.enabled", "false")  # Disable adaptive query execution
             # .config("spark.local.dir", "/D:/data-engineering/realtime_voting_system/temp")
             .getOrCreate())
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/D:/data-engineering/realtime_voting_system/checkpoint/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/D:/data-engineering/realtime_voting_system/checkpoint/checkpoint2") \
        .outputMode("update") \
        .start()
